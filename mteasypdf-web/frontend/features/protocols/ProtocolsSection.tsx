...
//       const result = await generateC5Document(excelFile, evidenceZip);
//       setDiagnostics(result.diagnostics);

//       const hasObservations =
//         result.diagnostics !== null &&
//         (result.diagnostics.resumen.imagenes_no_encontradas > 0 ||
//           result.diagnostics.resumen.imagenes_omitidas_por_dano > 0 ||
//           result.diagnostics.resumen.clasificaciones_no_encontradas > 0);
...
//       {error && (
//         <section className="rounded-[2rem] border border-red-200 bg-red-50 p-5 text-sm font-semibold text-red-700 shadow-sm">
//           {error}
//         </section>
//       )}

//       {message && (
//         <section className="rounded-[2rem] border border-emerald-200 bg-emerald-50 p-5 text-sm font-semibold text-emerald-700 shadow-sm">
//           {message}
//         </section>
//       )}
